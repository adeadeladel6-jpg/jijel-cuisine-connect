...
const ar: Dict = {
  ...
  catAll: "الكل",
  catSeafood: "المأكولات البحرية",
  catGrills: "المشاوي واللحوم",
  catStarters: "المقبلات والمعجنات",
  catMains: "الأطباق الرئيسية",
  catDesserts: "التحلية",
  catDrinks: "المشروبات",
  tagPopular: "الأكثر طلبًا",
  byWeight: "حسب الميزان",
  dishesCount: "طبق",
  ...
  resWhatsDesc: "تم فتح واتساب لإرسال تفاصيل حجزك. الدفع نقدًا فقط عند الوصول.",
...
const fr: Dict = {
  ...
  catAll: "Tout",
  catSeafood: "Fruits de mer",
  catGrills: "Grillades & viandes",
  catStarters: "Entrées & accompagnements",
  ...
  resWhatsDesc: "WhatsApp s'est ouvert pour envoyer les détails. Paiement en espèces à l'arrivée.",
